...
using trimController.UI;
using UitkForKsp2.API;
using UnityEngine;
using UnityEngine.UIElements;

namespace trimController;

[BepInPlugin(MyPluginInfo.PLUGIN_GUID, MyPluginInfo.PLUGIN_NAME, MyPluginInfo.PLUGIN_VERSION)]
[BepInDependency(SpaceWarpPlugin.ModGuid, SpaceWarpPlugin.ModVer)]
public class trimControllerPlugin : BaseSpaceWarpPlugin
{
    ...
    [PublicAPI] public static trimControllerPlugin Instance { get; set; }

    // AppBar button IDs
    internal const string ToolbarFlightButtonID = "BTN-trimControllerFlight";
    internal const string ToolbarOabButtonID = "BTN-trimControllerOAB";
    internal const string ToolbarKscButtonID = "BTN-trimControllerKSC";
    ...
    public override void OnInitialized()
    {
        ...
        var windowOptions = new WindowOptions
        {
            ...
            WindowId = "trimController_MyFirstWindow",
    ...
    private static void LoadAssemblies()
    {
        ...
        var unityAssembly = Assembly.LoadFrom(Path.Combine(currentFolder, "trimController.Unity.dll"));
